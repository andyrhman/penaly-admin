...
const SignIn = () => {
  const pageTitle = `Masuk | ${process.env.siteTitle}`;
  ...
  return (
    <Layout>
      <SEO title={pageTitle} />
      <div className="relative flex flex-1 flex-col lg:mt-32">
        <main>
                    ...
                    <form onSubmit={submit}>
                      <div className="mb-4">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={
                              usernameOrEmailError
                                ? ("w-full rounded-lg border border-rose-500 border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary")
                          ...
                          {usernameOrEmailError && <div className="text-[#B45454] text-xs mt-1">{usernameOrEmailError}</div>}
                        </div>
                      </div>
