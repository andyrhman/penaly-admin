                ...
                <article className="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
                    <footer className="flex justify-between items-center mb-2">
                        <div className="flex items-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400"><span>Feb. 8, 2022</span></p>
                        </div>
                ...
                <article className="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                    <footer className="flex justify-between items-center mb-2">
                        <div className="flex items-center">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400"><span>Mar. 12, 2022</span></p>
                        </div>
